...
class ReferenceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        frameCapture =
            ZonedFrameCapture(textureView, roiOverlay, ROI_WIDTH, ROI_HEIGHT, "Reference")
    ...
    private fun styledElementLabel(label: String): SpannableString {
        ...
        styled.setSpan(StyleSpan(Typeface.BOLD), 0, symbolEnd, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
    ...
    private fun saveReference(vector: MeasurementVector, elementName: String) {
        val referenceMeasurement = ReferenceMeasurement(
            ...
            cameraConfig = activeCameraConfig ?: CameraSessionSetup.previewConfiguration(
                useManualCameraControls
            ),
            rawFrames = emptyList(),
